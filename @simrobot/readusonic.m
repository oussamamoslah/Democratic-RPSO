...
[dists,num] = usonic8(round(pos), matrix, [simrobot.heading + simrobot.sensors(i).axisangle - simrobot.sensors(i).scanangle/2 simrobot.heading + simrobot.sensors(i).axisangle + simrobot.sensors(i).scanangle/2 simrobot.sensors(i).resolution simrobot.sensors(i).range]);
